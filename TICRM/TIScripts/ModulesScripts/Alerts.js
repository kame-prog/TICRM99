 ...
 * 24/7/2020
 * Alerts script file Containing all the scripts it use
 */
var url = window.location.pathname.toLowerCase();

//index Page Script Starts
if (url.includes("/alerts/index") || url == "/alerts") {
